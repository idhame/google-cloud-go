...
var (
	...
	now = time.Now
	// map of jwt algorithm to known Google certs URL
	knownGoogleCertMap = map[string]string{
		jwt.HeaderAlgRSA256: googleSACertsURL,
		jwt.HeaderAlgES256:  googleIAPCertsURL,
	}
)
